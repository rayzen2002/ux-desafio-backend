...
import { CreateProductSchema, PaginationSchema, UpdateProductSchema, type CreateProductDto, type PaginationDto, type UpdateProductDto } from './dto/create-products.dto';
...
export class ProductsController {
  ...
  async list(@Query() query: PaginationDto) {
    return this.productsService.listProducts(query.page, query.limit, query.name)
  }
